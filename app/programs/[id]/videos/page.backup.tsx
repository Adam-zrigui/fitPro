...
export default function CoursePage({ params }: { params: { id: string } }) {
  ...
  if (viewMode === 'video' && currentExercise && currentWorkout) {
    return (
          ...
          <div className="p-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg overflow-hidden mb-8">
              <div className="aspect-video bg-black">
                {currentExercise.video?.url || currentExercise.videoUrl ? (
                  <video
                    src={currentExercise.video?.url || currentExercise.videoUrl}
                    controls
                    autoPlay
                      ...
                      >
                        <div className="flex-shrink-0 mt-1">
                          {completedMap[exercise.id] ? (
                            ...
                            <div className="h-5 w-5 rounded border border-gray-300 dark:border-slate-600" />
                          )}
                        </div>
