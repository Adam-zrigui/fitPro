...
exports.initializeSubscriptionProducts = initializeSubscriptionProducts;
exports.getSubscriptionPriceIds = getSubscriptionPriceIds;
exports.getSubscriptionPriceId = getSubscriptionPriceId;
exports.initializeDefaultSubscription = initializeDefaultSubscription;
exports.getDefaultSubscriptionPriceId = getDefaultSubscriptionPriceId;
 ...
 */
async function initializeSubscriptionProducts() {
    try {
 ...
 */
async function getSubscriptionPriceIds() {
 ...
 */
async function getSubscriptionPriceId(planType) {
...
async function getDefaultSubscriptionPriceId() {
